...
{
    static const touchgfx::FontId DEFAULT = 0; // bahnschrift_30_4bpp
    static const touchgfx::FontId LARGE = 1;   // bahnschrift_150_4bpp
    static const touchgfx::FontId SMALL = 2;   // bahnschrift_15_4bpp
