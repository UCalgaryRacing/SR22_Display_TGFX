...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_bahnschrift_30_4bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_bahnschrift_150_4bpp());
        break;
    case 2:
